...
String _$notificationSchedulerHash() =>
    r'ad31b01842699af5df6535fe8b9300ec17e81960';
...
String _$notificationsGrantedHash() =>
    r'd89c218cc69f2a7a43a7b53ee94cef3f1ca75a8b';

/// See also [notificationsGranted].
@ProviderFor(notificationsGranted)
final notificationsGrantedProvider = AutoDisposeFutureProvider<bool>.internal(
  notificationsGranted,
  name: r'notificationsGrantedProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$notificationsGrantedHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef NotificationsGrantedRef = AutoDisposeFutureProviderRef<bool>;
